                ...
                <div className="max-w-md w-full text-center">
                    ...
                    <div className="mt-12 pt-8 border-t border-gray-200">
                        ...
                        <div className="grid grid-cols-2 gap-2 text-sm">
                            <Link href="/about" className="text-black hover:text-blue-600 transition-colors duration-200">
                                About Us
                            </Link>
                            <Link href="/elections" className="text-black hover:text-blue-600 transition-colors duration-200">
                                Elections
                            </Link>
                            <Link href="/issues" className="text-black hover:text-blue-600 transition-colors duration-200">
                                Issues
                            </Link>
                            <Link href="/resources" className="text-black hover:text-blue-600 transition-colors duration-200">
                                Resources
                            </Link>
                        </div>
                    </div>
